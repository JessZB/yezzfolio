...
import { createProjectSchema, updateProjectSchema, upsertSectionSchema, upsertAssetSchema, reorderSchema, } from './projects.schemas.js';
const router = Router();
...
router.post('/sections', validate(upsertSectionSchema), ProjectsController.upsertSection);
router.delete('/sections/:id', ProjectsController.deleteSection);
router.post('/assets', validate(upsertAssetSchema), ProjectsController.upsertAsset);
